...
<body class="bg-indigo-600 text-white min-h-screen flex items-center justify-center p-6 print:bg-white print:text-slate-900 print:items-start print:pt-10">

    <div class="max-w-md w-full">
        <!-- Success Banner (Disembunyikan saat dicetak) -->
        ...
        <!-- Ticket Card -->
        <div class="bg-white text-slate-900 rounded-[2.5rem] overflow-hidden shadow-2xl relative print:shadow-none print:border print:border-slate-300">
            <!-- Ticket Header -->
            ...
            <div class="px-8 pb-8 print:hidden">
