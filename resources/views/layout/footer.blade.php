<footer class="w-full bg-[#111111] py-12 mt-auto">
    <div class="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center">
        ...
        <p class="text-gray-400 text-sm">
            &copy; {{ date('Y') }} JOYA Portfolio. All rights reserved.
        </p>

        <!-- Social Icons -->
        <div class="flex space-x-4 mt-6 md:mt-0">
            <a href="#" class="p-2.5 bg-gray-800 rounded-full text-gray-300 hover:text-white hover:bg-[#f48c42] transition-colors">
                <!-- Twitter/X -->
